...
p_tmed_4=autoplot(tmed_4)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C2 - Boyacá del mes: Abril",subtitle = "Periodo 1981-2020 Fase: Llenado de tuberculo")+ geom_line(aes(y=tmed_4,colour="T. media °C"))  + geom_line(aes(y=16,colour="T. min Verticillium °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. min Verticillium °C"="green4"))
...
p_tmed_6=autoplot(tmed_6)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C2 - Boyacá del mes: Junio",subtitle = "Periodo 1981-2020 Fase: Senescencia")+ geom_line(aes(y=tmed_6,colour="T. media °C"))  + geom_line(aes(y=16,colour="T. min Verticillium °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. min Verticillium °C"="green4"))

p_tmed_7=autoplot(tmed_7)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C2 - Boyacá del mes: Julio",subtitle = "Periodo 1981-2020 Fase: Senescencia y Cosecha")+ geom_line(aes(y=tmed_7,colour="T. media °C"))  + geom_line(aes(y=16,colour="T. min Verticillium °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. min Verticillium °C"="green4"))

p_tmed_8=autoplot(tmed_8)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C2 - Boyacá del mes: Agosto",subtitle = "Periodo 1981-2020 Fase: Germinacion")+ geom_line(aes(y=tmed_8,colour="T. media °C"))  + geom_line(aes(y=16,colour="T. min Verticillium °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. min Verticillium °C"="green4"))
...
p_tmed_12=autoplot(tmed_12)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C2 - Boyacá del mes: Diciembre",subtitle = "Periodo 1981-2020 Fase: Senescencia")+ geom_line(aes(y=tmed_12,colour="T. media °C"))  + geom_line(aes(y=16,colour="T. min Verticillium °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. min Verticillium °C"="green4"))
...
```
```{r}
p_PCP_1=autoplot(PCP_1)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Enero",subtitle = "Periodo 1981-2019 Etapa: Germinacion")+ geom_line(aes(y=PCP_1,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_2=autoplot(PCP_2)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Febrero",subtitle = "Periodo 1981-2019 Etapa: Crec. Vegetativo e Ini. Tuberizacion")+ geom_line(aes(y=PCP_2,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_3=autoplot(PCP_3)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Marzo",subtitle = "Periodo 1981-2019 Etapa: Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_3,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_4=autoplot(PCP_4)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Abril",subtitle = "Periodo 1981-2019 Etapa: Llenado de tuberculo")+ geom_line(aes(y=PCP_4,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_5=autoplot(PCP_5)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Mayo",subtitle = "Periodo 1981-2019 Etapa: Senescencia")+ geom_line(aes(y=PCP_5,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_6=autoplot(PCP_6)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Junio",subtitle = "Periodo 1981-2019 Etapa: Senescencia y Cosecha")+ geom_line(aes(y=PCP_6,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_7=autoplot(PCP_7)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Julio",subtitle = "Periodo 1981-2019 Etapa: Germinacion")+ geom_line(aes(y=PCP_7,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_8=autoplot(PCP_8)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Agosto",subtitle = "Periodo 1981-2019 Etapa: Crec. Vegetativo e Ini. Tuberizacion")+ geom_line(aes(y=PCP_8,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_9=autoplot(PCP_9)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Septiembre",subtitle = "Periodo 1981-2019 Etapa: Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_9,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_10=autoplot(PCP_10)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Octubre",subtitle = "Periodo 1981-2019 Etapa: Llenado de tuberculo")+ geom_line(aes(y=PCP_10,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_11=autoplot(PCP_11)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Noviembre",subtitle = "Periodo 1981-2019 Etapa: Senescencia")+ geom_line(aes(y=PCP_11,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_12=autoplot(PCP_12)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C2 - Boyacá del mes: Diciembre",subtitle = "Periodo 1981-2019 Etapa: Senescencia y Cosecha")+ geom_line(aes(y=PCP_12,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))
...
```
```{r}
p_PCP_1=autoplot(PCP_1)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Enero",subtitle = "Periodo 2021-2025 Etapa: Germinacion")+ geom_line(aes(y=PCP_1,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))
...
p_PCP_3=autoplot(PCP_3)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Marzo",subtitle = "Periodo 2021-2025 Etapa: Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_3,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_4=autoplot(PCP_4)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Abril",subtitle = "Periodo 2021-2025  Etapa: Llenado de tuberculo")+ geom_line(aes(y=PCP_4,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_5=autoplot(PCP_5)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Mayo",subtitle = "Periodo 2021-2025 Etapa: Senescencia")+ geom_line(aes(y=PCP_5,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_6=autoplot(PCP_6)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Junio",subtitle = "Periodo 2021-2025 Etapa: Senescencia y Cosecha")+ geom_line(aes(y=PCP_6,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_7=autoplot(PCP_7)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Julio",subtitle = "Periodo 2021-2025 Etapa: Germinacion")+ geom_line(aes(y=PCP_7,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_8=autoplot(PCP_8)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Agosto",subtitle = "Periodo 2021-2025 Etapa: Crec. Vegetativo e Ini. Tuberizacion")+ geom_line(aes(y=PCP_8,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_9=autoplot(PCP_9)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Septiembre",subtitle = "Periodo 2021-2025 Etapa: Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_9,colour="PCP (mm)"))  + geom_line(aes(y=150,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))
...
p_PCP_11=autoplot(PCP_11)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Noviembre",subtitle = "Periodo 2021-2025 Etapa: Senescencia")+ geom_line(aes(y=PCP_11,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))

p_PCP_12=autoplot(PCP_12)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Pronostico de precipitacion C2 - Boyacá del mes: Diciembre",subtitle = "Periodo 2021-2025 Etapa: Senescencia y Cosecha")+ geom_line(aes(y=PCP_12,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="green4"))
