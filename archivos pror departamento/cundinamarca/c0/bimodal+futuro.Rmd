...
bimodales_cun_c0 <- read_excel("E:/COSAS DE OSCAR DEFINITIVO/OSCAR/2020-2/Proyecto- PAPA/ANOMALIAS/ANOMALIAS POR CLUSTER/entrada pror departamento/cundinamarca/c0/bimodales_cun_c0.xlsx", 
    sheet = "Hoja3")


dec1=ts(bimodales_cun_c0$`med_81-90`,start = 1,frequency = 1)
dec1

dec2=ts(bimodales_cun_c0$`med_91-00`,start = 1,frequency = 1)
dec2

dec3=ts(bimodales_cun_c0$`med_01-10`,start = 1,frequency = 1)
dec3

dec4=ts(bimodales_cun_c0$`med_11-19`,start = 1,frequency = 1)
dec4
```
```{r}
plot_dec=autoplot(dec1)+xlab("mes")+ylab("Precipitacion [mm]")+ggtitle("Comportamiento PCP C1",subtitle = "Periodo 1981-2019")
...
plot_dec2=autoplot(dec1)+xlab("mes")+ylab("Precipitacion [mm]")+ggtitle("Comportamiento PCP C1",subtitle = "Periodo 1981-2025")
...
p_tmed_2=autoplot(tmed_2)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C1 - Cundinamarca del mes: Febrero",subtitle = "Periodo 2021-2025 Fase: Germinacion")+ geom_line(aes(y=tmed_2,colour="T. media °C"))  + geom_line(aes(y=15,colour="T. limite °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. limite °C"="red"))
...
p_tmed_6=autoplot(tmed_6)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C1 - Cundinamarca del mes: Junio",subtitle = "Periodo 2021-2025 Fase: Senescencia")+ geom_line(aes(y=tmed_6,colour="T. media °C"))  + geom_line(aes(y=15,colour="T. limite °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. limite °C"="red"))
...
p_tmed_8=autoplot(tmed_8)+xlab("Año")+ylab("Temperatura media [°C]")+ggtitle("Temperatura media C1 - Cundinamarca del mes: Agosto",subtitle = "Periodo 2021-2025 Fase: Germinacion")+ geom_line(aes(y=tmed_8,colour="T. media °C"))  + geom_line(aes(y=15,colour="T. limite °C"))+ scale_colour_manual("", values=c("T. media °C"="black", "T. limite °C"="red"))
...
```
```{r}
p_PCP_1=autoplot(PCP_1)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Enero",subtitle = "Periodo 2021-2025 Fase: Senescencia y Cosecha")+ geom_line(aes(y=PCP_1,colour="PCP (mm)"))  + geom_line(aes(y=60,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_2=autoplot(PCP_2)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Febrero",subtitle = "Periodo 2021-2025 Fase: Germinacion")+ geom_line(aes(y=PCP_2,colour="PCP (mm)"))  + geom_line(aes(y=50,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_3=autoplot(PCP_3)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Marzo",subtitle = "Periodo 2021-2025 Fase: Crec. Vegetativo, Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_3,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_4=autoplot(PCP_4)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Abril",subtitle = "Periodo 2021-2025 Fase: Llenado de tuberculo")+ geom_line(aes(y=PCP_4,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_5=autoplot(PCP_5)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Mayo",subtitle = "Periodo 2021-2025 Fase: Llenado de tuberculo y Senescencia")+ geom_line(aes(y=PCP_5,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_6=autoplot(PCP_6)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Junio",subtitle = "Periodo 2021-2025 Fase: Senescencia")+ geom_line(aes(y=PCP_6,colour="PCP (mm)"))  + geom_line(aes(y=60,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_7=autoplot(PCP_7)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Julio",subtitle = "Periodo 2021-2025 Fase: Senescencia y Cosecha")+ geom_line(aes(y=PCP_7,colour="PCP (mm)"))  + geom_line(aes(y=60,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_8=autoplot(PCP_8)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Agosto",subtitle = "Periodo 2021-2025 Fase: Germinacion")+ geom_line(aes(y=PCP_8,colour="PCP (mm)"))  + geom_line(aes(y=50,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_9=autoplot(PCP_9)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Septiembre",subtitle = "Periodo 2021-2025 Fase: Crec. Vegetativo, Ini. Tuberizacion y Llenado de tuberculo")+ geom_line(aes(y=PCP_9,colour="PCP (mm)"))  + geom_line(aes(y=75,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_10=autoplot(PCP_10)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Octubre",subtitle = "Periodo 2021-2025 Fase: Llenado de tuberculo")+ geom_line(aes(y=PCP_10,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_11=autoplot(PCP_11)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Noviembre",subtitle = "Periodo 2021-2025 Fase: Llenado de tuberculo y Senescencia")+ geom_line(aes(y=PCP_11,colour="PCP (mm)"))  + geom_line(aes(y=100,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))

p_PCP_12=autoplot(PCP_12)+xlab("Año")+ylab("Precipitacion [mm]")+ggtitle("Precipitacion C1 - Cundinamarca del mes: Diciembre",subtitle = "Periodo 2021-2025 Fase: Senescencia")+ geom_line(aes(y=PCP_12,colour="PCP (mm)"))  + geom_line(aes(y=60,colour="Req. PCP (mm)"))+ scale_colour_manual("", values=c("PCP (mm)"="black", "Req. PCP (mm)"="red"))
